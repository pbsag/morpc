...
public class Tour implements java.io.Externalizable {
	...
	public void printTourState () {
		...
		logger.info( "");
		logger.info( "Tour object information");
		logger.info( "-----------------------");

		logger.info( "(short) tourType = " + tourType);
		logger.info( "(short) subTourType = " + subTourType);
		logger.info( "(short) subTourPerson = " + subTourPerson);
		logger.info( "(short) mode = " + mode);
		logger.info( "(short) submodeOB = " + submodeOB);
		logger.info( "(short) submodeIB = " + submodeIB);
		logger.info( "(short) timeOfDayAlt = " + timeOfDayAlt);
		logger.info( "(short) origTaz = " + origTaz);
		logger.info( "(short) destTaz = " + destTaz);
		logger.info( "(short) destShrtWlk = " + destShrtWlk);
		logger.info( "(short) tourOrder = " + tourOrder);
		logger.info( "(short) numPersons = " + numPersons);
		logger.info( "(short) numAdults = " + numAdults);
		logger.info( "(short) numChildren = " + numChildren);
		logger.info( "(short) numPreschool = " + numPreschool);
		logger.info( "(short) numPredriv = " + numPredriv);
		logger.info( "(short) numUniv = " + numUniv);
		logger.info( "(short) allWorkFull = " + allWorkFull);
		logger.info( "(short) stopFreqAlt = " + stopFreqAlt);
		logger.info( "(short) stopLocOB = " + stopLocOB);
		logger.info( "(short) stopLocIB = " + stopLocIB);
		logger.info( "(short) stopLocSubzoneOB = " + stopLocSubzoneOB);
		logger.info( "(short) stopLocSubzoneIB = " + stopLocSubzoneIB);

		logger.info( "(boolean[]) personParticipation = ");
		...
		logger.info( "(short[]) subToursByType = ");
