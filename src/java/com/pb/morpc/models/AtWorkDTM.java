...
public class AtWorkDTM implements java.io.Serializable {
    ...
    public AtWorkDTM (HashMap propertyMap, HouseholdArrayManager hhMgr, ZonalDataManager zdm) {

		this.propertyMap = propertyMap;
		this.hhMgr = hhMgr;


		dtmHH = new DTMHousehold (propertyMap, TourType.AT_WORK_CATEGORY, TourType.AT_WORK_TYPES, zdm);
    }
