...
public class JointSmcTask implements Callable<List<Object>> {
    ...
    public JointSmcTask ( StopsHousehold stopsHH, int taskIndex, int startIndex, int endIndex, Household[] hhList ) {
