...
public class ManSmcTask implements Callable<List<Object>> {
    ...
    public ManSmcTask ( StopsHousehold stopsHH, int taskIndex, int startIndex, int endIndex, Household[] hhList ) {
