...
public class NonManSmcTask implements Callable<List<Object>> {
    ...
    public NonManSmcTask ( StopsHousehold stopsHH, int taskIndex, int startIndex, int endIndex, Household[] hhList ) {
