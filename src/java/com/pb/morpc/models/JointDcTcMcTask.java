...
public class JointDcTcMcTask implements Callable<List<Object>> {
    ...
    public JointDcTcMcTask ( DTMHousehold dtmHH, int taskIndex, int startIndex, int endIndex, Household[] hhList ) {
        this.dtmHH = dtmHH;
    ...
    public List<Object> call() {
        ...
        for (int i=startIndex; i <= endIndex; i++) {
            try {
                ...
                logger.fatal ("exception caught in JointDcTcMcTask " + taskIndex + ", hhList range [" + startIndex + "," + endIndex + "] for household id=" + hhList[i].getID() + ".", e );
