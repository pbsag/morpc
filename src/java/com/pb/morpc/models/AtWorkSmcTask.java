...
public class AtWorkSmcTask implements Callable<List<Object>> {
    ...
    public AtWorkSmcTask ( StopsHousehold stopsHH, int taskIndex, int startIndex, int endIndex, Household[] hhList ) {
