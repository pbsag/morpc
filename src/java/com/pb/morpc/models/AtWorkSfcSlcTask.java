...
public class AtWorkSfcSlcTask implements Callable<List<Object>> {
    ...
    public AtWorkSfcSlcTask ( StopsHousehold stopsHH, int taskIndex, int startIndex, int endIndex, Household[] hhList ) {
    ...
    public List<Object> call() {
        ...
        for (int i=startIndex; i <= endIndex; i++) {
            try {
                ...
                logger.fatal ("exception caught in AtWorkSfcSlcTask " + taskIndex + ", hhList range [" + startIndex + "," + endIndex + "] for household id=" + hhList[i].getID() + ".", e );
