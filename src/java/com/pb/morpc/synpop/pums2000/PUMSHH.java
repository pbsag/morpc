...
public class PUMSHH extends HH implements Cloneable {
    ...
    public static final String[] HHSIZE_BASE_Labels = {
        "1", "2", "3", "4", "5", "6+"
    };

    //    public static final float[] HHSIZE_BASE_Categories = { 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.5f };
    public static final String[] HHSIZE_Labels = {
        "1", "2", "3", "4", "5", "6", "7", "8", "9+"
    };
    public static final float[] HHSIZE_Categories = {
        1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 10.1f
    };
    ...
    public static final float[] WORKER_Categories = {
        0.0f, 1.0f, 2.0f, 3.0f, 4.0f, 5.2f
    };
    ...
    public static final float[] INCOME_Categories = {
        15000.0f, 52500.0f, 85000.0f
    };
    ...
    **/
    public static int getHHSizeCategory(int hhSize) {
        if (hhSize <= 0) {
            logger.severe("trying to set HH Size category for hhSize= " +
                hhSize + ".  HH Size should be >= 1.");
    ...
    **/
    public static int getWorkerCategory(int workers) {
        if (workers < 0) {
            logger.severe("trying to set HH Workers category for workers= " +
                workers + ".  HH Workers should be >= 0.");
    ...
    **/
    public int getPersonType(int personNumberInHH) {
        if ((personNumberInHH < 0) || (personNumberInHH >= HHSIZES)) {
            logger.severe("trying to get person type for personNumberInHH= " +
                personNumberInHH + ".  HH person number should be >= 0 and < " +
                HHSIZES + ".");
